...
REM
REM Everything else is done already: main is pushed, the v0.4.3 tag is on GitHub, and
...
set TAG=v0.4.3
set ZIP=dist\WindowMark-v0.4.3-win64.zip
set NOTES=dist\release-notes-v0.4.3.md
