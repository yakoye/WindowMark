...
REM
REM Everything else is done already: main is pushed, the v0.4.5 tag is on GitHub, and
...
set TAG=v0.4.5
set ZIP=dist\WindowMark-v0.4.5-win64.zip
set NOTES=dist\release-notes-v0.4.5.md
