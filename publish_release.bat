...
REM
REM Everything else is done already: main is pushed, the v0.4.1 tag is on GitHub, and
...
set TAG=v0.4.1
set ZIP=dist\WindowMark-v0.4.1-win64.zip
set NOTES=dist\release-notes-v0.4.1.md
